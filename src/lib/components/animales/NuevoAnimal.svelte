...
<div class="form-control">
    ...
    <SelectFertil bind:value={sexo} opciones={sexos} etiqueta="Sexo" />
    <div class="hidden">
    ...
    <SelectFertil
        bind:value={rodeo}
        etiqueta="Rodeo"
        opciones={rodeos.filter((r) => r.active && r.cab == cabid)}
    />
    <div class="hidden">
    ...
    <SelectFertil
        bind:value={lote}
        etiqueta="Lote"
        opciones={lotes.filter((r) => r.active && r.cab == cabid)}
    />
    <div class="hidden">
