<script>
    ...
    async function guardarTratamientoOnline() {
        ...
        try {
            ...
            Swal.fire(
                "Éxito guardar",
                "Se logró guardar el tratamiento",
                "success",
            );
        } catch (err) {
            console.error(err);
            Swal.fire(
                "Error guardar",
                "No se logró guardar el tratamiento",
                "success",
            );
        }
    }
    async function guardarTratamientoOffline() {
        ...
        data = {
            ...
            expand: {
                ...
                tipo: {
                    id: tipo,
                    nombre: tipotratamientos.filter((t) => t.id == tipo)[0]
                        .nombre,
                },
            },
        };
    ...
    function onChangeTrats() {
        tratamientosrows = tratamientos.filter(
            (t) => t.active && t.animal == id,
        );
    }
    onMount(async () => {
        id = $page.params.slug;
        ...
        <div class="modal-action justify-start">
            <form method="dialog">
                <button
                    ...
                    onclick={guardarTratamiento}>Guardar</button
                >
