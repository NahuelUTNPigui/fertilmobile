<script>
    ...
    async function getAnimales() {
        ...
        let animales = animalestodos.lista.filter(
            (a) => a.cab == cabid && a.delete == false,
        );
    ...
    async function guardarParicionOnline() {
        ...
        try {
            ...
            Swal.fire(
                "Error guardar",
                "No se pudo guardar la paricion con exito",
                "success",
            );
        }
    }
    ...
    function openNewModal(p_id) {
        ...
        if (idnacimiento == "") {
            ...
            fecha = new Date(pariciones[i_par].fecha)
                .toISOString()
                .split("T")[0];
            ...
            <form method="dialog">
                ...
                {#if idnacimiento == ""}
                    <button
                        ...
                        onclick={guardarParicion}>Guardar</button
                    >
                {/if}
