...
<div class="drawer min-h-screen dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800">
    ...
    <div class="drawer-side">
      ...
      >
        ...
        <li  class={`mt-0 ${pageurl.includes("inicio")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          <a class = {classtext} href="/inicio">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="pl-3 size-10">
        ...
        <li class={`${cab.exist?"":"disabled"} ${pageurl.includes("tratamientos")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          ...
          <a class = {classtext} href="/tratamientos">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hidden size-10">
        ...
        <li class={` ${cab.exist?"":"disabled"} ${pageurl.includes("movimientos")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          {#if cab.exist}
        ...
        <!--Pesajes-->
        <li class={` ${cab.exist?"":"disabled"} ${pageurl.includes("pesajes")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          {#if cab.exist}
        ...
        <!--Lotes-->
        <li class={` ${cab.exist?"":"disabled"} ${pageurl.includes("lotes")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          {#if cab.exist}
        ...
        <!--Importar-->
        <li class={`${cab.exist?"":"disabled"} ${pageurl.includes("importar")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          {#if cab.exist}
        ...
        <li class={` ${cab.exist?"":"disabled"} ${pageurl.includes("pendientes")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          {#if cab.exist}
        ...
        <!--Manual-->
        <li class={`${cab.exist?"":"disabled"} ${pageurl.includes("manual")?"bg-green-400 text-green-900 dark:bg-green-900 dark:text-green-200 bg-opacity-25":""} rounded-full`}>
          {#if cab.exist}
            <a class={`py-0 ${classtext}`} href={pre+"/manual"}>
              
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ml-3 size-8">
