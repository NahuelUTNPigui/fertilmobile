...
<div class="form-control">
    ...
    {#if !agregaranimal}
        <div class="hidden">
            ...
            <label class="input-group">
                ...
                <div
                    class={`label ${tratamiento.malanimaltrat ? "" : "hidden"}`}
                >
        ...
        <label class="input-group">
            <select
                class={`
                    ...
                    ${estilos.bgdark2} 
                `}
                bind:value={tratamiento.categoriatrat}
                read
    ...
    {/if}
    <CustomDate
        etiqueta="Fecha tratamiento"
        onchange={() => oninputTrat("FECHA")}
        bind:fecha={tratamiento.fechatrat}
    />
    ...
    <SelectFertil
        ...
        bind:opciones={tipotratamientos}
    />
